...
//   it('should create enrollments of a tracked entity instance into a program', () => {
//     const state = {
//       ...initialState,
//       data: {
//         enrollment: {
...
//     return execute(create('enrollments', state => state.data.dataValueSet))(
//       state
//     ).then(state => {
