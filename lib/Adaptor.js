...
function del(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion8, _CONTENT_TYPES$respon8, _options$supportApiVe3;
    ...
    var queryParams = (0, _Utils.recursivelyExpandReferences)(params)(state);
    var payload = (0, _Utils.recursivelyExpandReferences)(data)(state);
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options$replace, _options$responseType6, _options$apiVersion9, _CONTENT_TYPES$respon9;

    var operationName = (_options$operationNam4 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam4 !== void 0 ? _options$operationNam4 : 'upsert';
