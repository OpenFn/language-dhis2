...
function getResources(params, options, callback) {
  return function (state) {
    ...
    var url = (0, _Utils.buildUrl)(getResources, null, state.configuration, options);
    (0, _Utils.logApiVersion)(state.configuration, options);
    (0, _Utils.logWaitingForServer)(url, params);
    (0, _Utils.warnExpectLargeResult)(params, url);
    return _axios["default"].request({
      ...
      _Utils.Log.info((0, _Utils.composeSuccessMessage)(getResources, null, params, options, callback));
...
function getData(resourceType, params, options, callback) {
  return function (state) {
    ...
    var url = (0, _Utils.buildUrl)(getData, resourceType, state === null || state === void 0 ? void 0 : state.configuration, options);
    (0, _Utils.logApiVersion)(state.configuration, options);
    (0, _Utils.logWaitingForServer)(url, params);
    (0, _Utils.warnExpectLargeResult)(resourceType, url);
    return _axios["default"].request({
      ...
      _Utils.Log.info((0, _Utils.composeSuccessMessage)(getData, resourceType, params, options, callback));
...
function getMetadata(resources, params, options, callback) {
  return function (state) {
    ...
    var url = (0, _Utils.buildUrl)(getMetadata, resources, state === null || state === void 0 ? void 0 : state.configuration, options);
    (0, _Utils.logApiVersion)(state.configuration, options);
