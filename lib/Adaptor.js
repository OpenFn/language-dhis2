...
function create(resourceType, data, options, params, callback) {
  return state => {
    ...
    const expandedData = (0, _languageCommon.expandReferences)(data)(state);
    const body = nestArray(expandedData, resourceType);
    const expandedResourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    const expandedOptions = (0, _languageCommon.expandReferences)(options)(state);
    const expandedParams = (0, _languageCommon.expandReferences)(params)(state);
    const operationName = (_expandedOptions$oper = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.operationName) !== null && _expandedOptions$oper !== void 0 ? _expandedOptions$oper : 'create';
    const {
      username,
      password,
      hostUrl
    } = state.configuration;
    const responseType = (_expandedOptions$resp = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.responseType) !== null && _expandedOptions$resp !== void 0 ? _expandedOptions$resp : 'json';
    ...
    const url = (0, _Utils.buildUrl)('/' + expandedResourceType, hostUrl, apiVersion);
    const headers = {
    ...
    return _axios.default.request({
      ...
      _Utils.Log.info(`${operationName} succeeded. Created ${expandedResourceType}: ${((_result$data$response = result.data.response) === null || _result$data$response === void 0 ? void 0 : _result$data$response.importSummaries) ? result.data.response.importSummaries[0].href : (_result$data$response2 = result.data.response) === null || _result$data$response2 === void 0 ? void 0 : _result$data$response2.reference}.\nSummary:\n${(0, _Utils.prettyJson)(result.data)}`);
...
function update(resourceType, path, data, params, options, callback) {
  return state => {
    ...
    const expandedResourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    const expandedPath = (0, _languageCommon.expandReferences)(path)(state);
    ...
    const operationName = (_expandedOptions$oper2 = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.operationName) !== null && _expandedOptions$oper2 !== void 0 ? _expandedOptions$oper2 : 'update';
    const filters = expandedParams === null || expandedParams === void 0 ? void 0 : expandedParams.filters;
    expandedParams === null || expandedParams === void 0 ? true : delete expandedParams.filters;
    ...
    const apiVersion = (_expandedOptions$apiV2 = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.apiVersion) !== null && _expandedOptions$apiV2 !== void 0 ? _expandedOptions$apiV2 : state.configuration.apiVersion;
    const url = (0, _Utils.buildUrl)('/' + expandedResourceType + '/' + expandedPath, hostUrl, apiVersion);
    const headers = {
    ...
    return _axios.default.request({
      ...
      _Utils.Log.info(`${operationName} succeeded. Updated ${expandedResourceType}.\nSummary:\n${(0, _Utils.prettyJson)(result.data)}`);
...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return state => {
    ...
    const apiVersion = (_expandedOptions$apiV3 = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.apiVersion) !== null && _expandedOptions$apiV3 !== void 0 ? _expandedOptions$apiV3 : state.configuration.apiVersion;
...
function getMetadata(resources, params, options, callback) {
  return state => {
    ...
    filters === null || filters === void 0 ? void 0 : filters.map(f => queryParams.append('filter', f));
    const apiVersion = (_options$apiVersion3 = (_options8 = options) === null || _options8 === void 0 ? void 0 : _options8.apiVersion) !== null && _options$apiVersion3 !== void 0 ? _options$apiVersion3 : state.configuration.apiVersion;
    const headers = {
...
function patch(resourceType, path, data, params, options, callback) {
  return state => {
    ...
    queryParams = new URLSearchParams(queryParams);
    filters === null || filters === void 0 ? void 0 : filters.map(f => queryParams.append('filter', f));
    const apiVersion = (_options$apiVersion4 = (_options11 = options) === null || _options11 === void 0 ? void 0 : _options11.apiVersion) !== null && _options$apiVersion4 !== void 0 ? _options$apiVersion4 : state.configuration.apiVersion;
...
function del(resourceType, path, data, params, options, callback) {
  return state => {
    ...
    queryParams = new URLSearchParams(queryParams);
    filters === null || filters === void 0 ? void 0 : filters.map(f => queryParams.append('filter', f));
    const apiVersion = (_options$apiVersion5 = (_options14 = options) === null || _options14 === void 0 ? void 0 : _options14.apiVersion) !== null && _options$apiVersion5 !== void 0 ? _options$apiVersion5 : state.configuration.apiVersion;
    const headers = {
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return state => {
    ...
    const apiVersion = (_options$apiVersion6 = (_options18 = options) === null || _options18 === void 0 ? void 0 : _options18.apiVersion) !== null && _options$apiVersion6 !== void 0 ? _options$apiVersion6 : state.configuration.apiVersion;
    const url = (0, _Utils.buildUrl)('/' + resourceType, hostUrl, apiVersion);
    const headers = {
    ...
    return Promise.all([getResouceName(), findRecordsWithValueOnAttribute()]).then(([resourceName, recordsWithValue]) => {
      ...
      if (recordsWithValueCount > 1) {
        ...
        return _axios.default.request({
          ...
          _Utils.Log.info(`${operationName} succeeded. Created ${resourceName}: ${result.data.response.importSummaries ? result.data.response.importSummaries[0].href : (_result$data$response3 = result.data.response) === null || _result$data$response3 === void 0 ? void 0 : _result$data$response3.reference}.\nSummary:\n${(0, _Utils.prettyJson)(result.data)}`);
