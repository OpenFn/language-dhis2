...
function create(resourceType, data, options, callback) {
  ...
  return state => {
    const {
      ...
      urlParams,
      callback
    } = (0, _Utils.expandExtractAndLog)('create', initialParams)(state);
    return (0, _Client.post)(url, (0, _Utils.nestArray)(data, resourceType), {
      auth,
      params: urlParams
    }).then(result => {
...
function update(resourceType, path, data, options, callback) {
  ...
  return state => {
    const {
      ...
      _,
      callback
    } = (0, _Utils.expandExtractAndLog)('update', initialParams)(state);
    return (0, _Client.put)(url, data, {
      auth
    }).then(result => {
...
function getTEIs(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getTEIs');
...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return state => {
    ...
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'upsertTEI');
    const {
      password,
      username,
      hostUrl
...
function getEvents(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getEvents');
...
function getPrograms(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getPrograms');
...
function getEnrollments(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getEnrollments');
...
function updateEnrollments(path, data, params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'updateEnrollments');
...
function cancelEnrollment(enrollmentId, params, options, callback) {
  return state => {
    ...
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'cancelEnrollment');
...
function completeEnrollment(enrollmentId, params, options, callback) {
  return state => {
    ...
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'enrollments');
    return update('enrollments', path, null, params, expandedOptions, callback)(state);
  };
}
/**
...
function getRelationships(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getRelationships');
...
function getDataValues(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getDataValues');
...
function generateDhis2UID(options, callback) {
  return state => {
    ...
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'generateDhis2UID');
    const limit = {
...
function getAnalytics(params, options, callback) {
  return state => {
    const expandedOptions = (0, _Utils.expandAndSetOperation)(options, state, 'getAnalytics');
