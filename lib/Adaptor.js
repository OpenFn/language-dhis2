...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return function (state) {
    var _options$apiVersion, _options$requireUniqu, _state$data$attribute, _state$data$attribute2;
    ...
    params === null || params === void 0 ? void 0 : params.push(ou);
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$replace, _options$responseType3, _options$apiVersion9, _CONTENT_TYPES$respon9;
    ...
    var queryParams = new URLSearchParams(params === null || params === void 0 ? void 0 : params.map(function (item) {
      ...
      return (_Object$entries3 = Object.entries(item)) === null || _Object$entries3 === void 0 ? void 0 : _Object$entries3.flat();
    }));
