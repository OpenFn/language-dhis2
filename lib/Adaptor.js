...
function extractValuesForAxios(operationName, values) {
  return state => {
    var _values$options$apiVe, _values$options, _values$options2;
    ...
    const url = (0, _Utils.buildUrl)(urlString, hostUrl, apiVersion);
    const urlParams = new URLSearchParams((_values$options2 = values.options) === null || _values$options2 === void 0 ? void 0 : _values$options2.params);
    return {
...
function create(resourceType, data, options, callback) {
  ...
  return state => {
    ...
    return (0, _Client.post)(url, nestArray(data, resourceType), {
      auth,
      params: urlParams
    }).then(result => {
...
function update(resourceType, path, data, options, callback) {
  ...
  return state => {
    const {
      ...
      _,
      callback
    } = expandExtractAndLog('update', initialParams)(state);
