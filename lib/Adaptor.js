...
function getTEIs(params, options, callback) {
  return function (state) {
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return function (state) {
    var _options$apiVersion, _options, _options$requireUniqu, _options2, _body$attributes, _body$attributes$find;

    uniqueAttributeId = (0, _Utils.recursivelyExpandReferences)(uniqueAttributeId)(state);
    var body = (0, _Utils.recursivelyExpandReferences)(data)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    ...
    var requireUniqueAttributeConfig = (_options$requireUniqu = (_options2 = options) === null || _options2 === void 0 ? void 0 : _options2.requireUniqueAttributeConfig) !== null && _options$requireUniqu !== void 0 ? _options$requireUniqu : true;
    var params = {
      ou: body.orgUnit
    };
...
function getEnrollments(params, responseType, options, callback) {
  return function (state) {
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
...
function cancelEnrollment(enrollmentId, params, options, callback) {
  return function (state) {
    enrollmentId = (0, _Utils.recursivelyExpandReferences)(enrollmentId)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
...
function createDataValues(data, params, options, callback) {
  return function (state) {
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
...
function generateDhis2UID(params, options, callback) {
  return function (state) {
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
...
function discover(operation, path) {
  return function (state) {
    return _axios["default"].get('https://dhis2.github.io/dhis2-api-specification/spec/metadata_openapi.json', {
      ...
      _Utils.Log.info("\t=======================================================================================\n\tQuery Parameters for ".concat(_Utils.COLORS.FgGreen).concat(operation).concat(_Utils.ESCAPE, " on ").concat(_Utils.COLORS.FgGreen).concat(path).concat(_Utils.ESCAPE, " [").concat((_result$data$descript = result.data.description) !== null && _result$data$descript !== void 0 ? _result$data$descript : '<description_missing>', "]\n\t======================================================================================="));
...
function getAnalytics(resourceType, params, options, callback) {
  return function (state) {
    resourceType = (0, _Utils.recursivelyExpandReferences)(resourceType)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    ...
    return getData("analytics/".concat(resourceType), params, options, callback)(state);
  };
}
/**
...
function getResources(params, options, callback) {
  return function (state) {
    var _options$responseType, _options3, _params, _CONTENT_TYPES$respon;

    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    ...
    var responseType = (_options$responseType = (_options3 = options) === null || _options3 === void 0 ? void 0 : _options3.responseType) !== null && _options$responseType !== void 0 ? _options$responseType : 'json';
    ...
    return _axios["default"].request({
      ...
      (0, _Utils.composeSuccessMessage)('getResources');
...
function getSchema(resourceType, params, options, callback) {
  return function (state) {
    var _options$responseType2, _options4, _params2, _params3, _options$apiVersion2, _options5, _CONTENT_TYPES$respon2, _resourceType;
    ...
    var responseType = (_options$responseType2 = (_options4 = options) === null || _options4 === void 0 ? void 0 : _options4.responseType) !== null && _options$responseType2 !== void 0 ? _options$responseType2 : 'json';
    ...
    var apiVersion = (_options$apiVersion2 = (_options5 = options) === null || _options5 === void 0 ? void 0 : _options5.apiVersion) !== null && _options$apiVersion2 !== void 0 ? _options$apiVersion2 : state.configuration.apiVersion;
    var headers = {
...
function getData(resourceType, params, options, callback) {
  return function (state) {
    var _options$operationNam, _options6, _options$responseType3, _options7, _params4, _params5, _options$apiVersion3, _options8, _CONTENT_TYPES$respon3;

    resourceType = (0, _Utils.recursivelyExpandReferences)(resourceType)(state);
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    var operationName = (_options$operationNam = (_options6 = options) === null || _options6 === void 0 ? void 0 : _options6.operationName) !== null && _options$operationNam !== void 0 ? _options$operationNam : 'getData';
    ...
    var responseType = (_options$responseType3 = (_options7 = options) === null || _options7 === void 0 ? void 0 : _options7.responseType) !== null && _options$responseType3 !== void 0 ? _options$responseType3 : 'json';
    var filters = (_params4 = params) === null || _params4 === void 0 ? void 0 : _params4.filters;
    (_params5 = params) === null || _params5 === void 0 ? true : delete _params5.filters;
    var queryParams = new URLSearchParams(params);
    filters === null || filters === void 0 ? void 0 : filters.map(function (f) {
      return queryParams.append('filter', f);
    });
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info((0, _Utils.composeSuccessMessage)('GET ' + resourceType));
...
function getMetadata(resources, params, options, callback) {
  return function (state) {
    var _options$responseType4, _options9, _options$apiVersion4, _options10, _CONTENT_TYPES$respon4;

    resources = (0, _Utils.recursivelyExpandReferences)(resources)(state);
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    ...
    var responseType = (_options$responseType4 = (_options9 = options) === null || _options9 === void 0 ? void 0 : _options9.responseType) !== null && _options$responseType4 !== void 0 ? _options$responseType4 : 'json';

    var queryParams = _objectSpread({}, resources, {}, params)(state);

    var apiVersion = (_options$apiVersion4 = (_options10 = options) === null || _options10 === void 0 ? void 0 : _options10.apiVersion) !== null && _options$apiVersion4 !== void 0 ? _options$apiVersion4 : state.configuration.apiVersion;
    var headers = {
...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    var _options$operationNam2, _options11, _options$responseType5, _options12, _params6, _params7, _options$apiVersion5, _options13, _CONTENT_TYPES$respon5;

    resourceType = (0, _Utils.recursivelyExpandReferences)(resourceType)(state);
    var body = (0, _Utils.recursivelyExpandReferences)(data)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    var operationName = (_options$operationNam2 = (_options11 = options) === null || _options11 === void 0 ? void 0 : _options11.operationName) !== null && _options$operationNam2 !== void 0 ? _options$operationNam2 : 'create';
    ...
    var responseType = (_options$responseType5 = (_options12 = options) === null || _options12 === void 0 ? void 0 : _options12.responseType) !== null && _options$responseType5 !== void 0 ? _options$responseType5 : 'json';
    var filters = (_params6 = params) === null || _params6 === void 0 ? void 0 : _params6.filters;
    (_params7 = params) === null || _params7 === void 0 ? true : delete _params7.filters;
    var queryParams = new URLSearchParams(params);
    var apiVersion = (_options$apiVersion5 = (_options13 = options) === null || _options13 === void 0 ? void 0 : _options13.apiVersion) !== null && _options$apiVersion5 !== void 0 ? _options$apiVersion5 : state.configuration.apiVersion;
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info("".concat(_Utils.COLORS.FgGreen).concat(operationName, " succeeded").concat(_Utils.ESCAPE, ". Created ").concat(resourceType, ": ").concat(_Utils.COLORS.FgGreen).concat(result.data.response.importSummaries ? result.data.response.importSummaries[0].href : (_result$data$response = result.data.response) === null || _result$data$response === void 0 ? void 0 : _result$data$response.reference).concat(_Utils.ESCAPE, ".\nSummary:\n").concat((0, _Utils.prettyJson)(result.data)));
...
function update(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options14, _options$responseType6, _options15, _params8, _params9, _options$apiVersion6, _options16, _CONTENT_TYPES$respon6;

    resourceType = (0, _Utils.recursivelyExpandReferences)(resourceType)(state);
    path = (0, _Utils.recursivelyExpandReferences)(path)(state);
    var body = (0, _Utils.recursivelyExpandReferences)(data)(state);
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    ...
    var operationName = (_options$operationNam3 = (_options14 = options) === null || _options14 === void 0 ? void 0 : _options14.operationName) !== null && _options$operationNam3 !== void 0 ? _options$operationNam3 : 'update';
    var responseType = (_options$responseType6 = (_options15 = options) === null || _options15 === void 0 ? void 0 : _options15.responseType) !== null && _options$responseType6 !== void 0 ? _options$responseType6 : 'json';
    var filters = (_params8 = params) === null || _params8 === void 0 ? void 0 : _params8.filters;
    (_params9 = params) === null || _params9 === void 0 ? true : delete _params9.filters;
    var queryParams = new URLSearchParams(params);
    filters === null || filters === void 0 ? void 0 : filters.map(function (f) {
      return queryParams.append('filter', f);
    });
    var apiVersion = (_options$apiVersion6 = (_options16 = options) === null || _options16 === void 0 ? void 0 : _options16.apiVersion) !== null && _options$apiVersion6 !== void 0 ? _options$apiVersion6 : state.configuration.apiVersion;
...
function patch(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options17, _options$responseType7, _options18, _queryParams, _queryParams2, _options$apiVersion7, _options19, _CONTENT_TYPES$respon7;
    ...
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    var operationName = (_options$operationNam4 = (_options17 = options) === null || _options17 === void 0 ? void 0 : _options17.operationName) !== null && _options$operationNam4 !== void 0 ? _options$operationNam4 : 'patch';
    ...
    var responseType = (_options$responseType7 = (_options18 = options) === null || _options18 === void 0 ? void 0 : _options18.responseType) !== null && _options$responseType7 !== void 0 ? _options$responseType7 : 'json';
    var queryParams = params;
    ...
    var apiVersion = (_options$apiVersion7 = (_options19 = options) === null || _options19 === void 0 ? void 0 : _options19.apiVersion) !== null && _options$apiVersion7 !== void 0 ? _options$apiVersion7 : state.configuration.apiVersion;
    var url = (0, _Utils.buildUrl)('/' + resourceType + '/' + path, hostUrl, apiVersion);
    var headers = {
...
function del(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam5, _options20, _options$responseType8, _options21, _queryParams3, _queryParams4, _options$apiVersion8, _options22, _CONTENT_TYPES$respon8;
    ...
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    var operationName = (_options$operationNam5 = (_options20 = options) === null || _options20 === void 0 ? void 0 : _options20.operationName) !== null && _options$operationNam5 !== void 0 ? _options$operationNam5 : 'delete';
    ...
    var responseType = (_options$responseType8 = (_options21 = options) === null || _options21 === void 0 ? void 0 : _options21.responseType) !== null && _options$responseType8 !== void 0 ? _options$responseType8 : 'json';
    var queryParams = params;
    ...
    var apiVersion = (_options$apiVersion8 = (_options22 = options) === null || _options22 === void 0 ? void 0 : _options22.apiVersion) !== null && _options$apiVersion8 !== void 0 ? _options$apiVersion8 : state.configuration.apiVersion;
    var headers = {
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam6, _options23, _options$replace, _options24, _options$responseType9, _options25, _params10, _options$apiVersion9, _options26, _CONTENT_TYPES$respon9;

    resourceType = (0, _Utils.recursivelyExpandReferences)(resourceType)(state);
    uniqueAttribute = (0, _Utils.recursivelyExpandReferences)(uniqueAttribute)(state);
    var body = (0, _Utils.recursivelyExpandReferences)(data)(state);
    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    options = (0, _Utils.recursivelyExpandReferences)(options)(state);
    var operationName = (_options$operationNam6 = (_options23 = options) === null || _options23 === void 0 ? void 0 : _options23.operationName) !== null && _options$operationNam6 !== void 0 ? _options$operationNam6 : 'upsert';
    ...
    var replace = (_options$replace = (_options24 = options) === null || _options24 === void 0 ? void 0 : _options24.replace) !== null && _options$replace !== void 0 ? _options$replace : false;
    var responseType = (_options$responseType9 = (_options25 = options) === null || _options25 === void 0 ? void 0 : _options25.responseType) !== null && _options$responseType9 !== void 0 ? _options$responseType9 : 'json';
    ...
    var filters = (_params10 = params) === null || _params10 === void 0 ? void 0 : _params10.filters;
    ...
    var apiVersion = (_options$apiVersion9 = (_options26 = options) === null || _options26 === void 0 ? void 0 : _options26.apiVersion) !== null && _options$apiVersion9 !== void 0 ? _options$apiVersion9 : state.configuration.apiVersion;
    var url = (0, _Utils.buildUrl)('/' + resourceType, hostUrl, apiVersion);
    var headers = {
