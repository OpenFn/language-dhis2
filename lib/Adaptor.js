...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return function (state) {
    ...
    var _state$configuration2 = state.configuration,
        ...
        hostUrl = _state$configuration2.hostUrl; // console.log('Data before expansion', data);

    var body = (0, _languageCommon.expandReferences)(data)(state); // console.log('Body after expansion', body);
