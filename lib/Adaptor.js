...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    ...
    var preparedData = isArray(data) ? _defineProperty({}, resourceType, data) : data;
    var body = (0, _languageCommon.expandReferences)(preparedData)(state);
    ...
    console.log('debugging for taylor and elias', url, queryParams, body, headers);
...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return function (state) {
    var _expandedOptions$apiV2, _expandedOptions$stri, _body$attributes, _body$attributes$find;
...
function update(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam2, _options9, _options$responseType5, _options10, _params7, _params8, _options$apiVersion4, _options11, _CONTENT_TYPES$respon6;
    ...
    var operationName = (_options$operationNam2 = (_options9 = options) === null || _options9 === void 0 ? void 0 : _options9.operationName) !== null && _options$operationNam2 !== void 0 ? _options$operationNam2 : 'update';
...
function patch(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options12, _options$responseType6, _options13, _queryParams3, _queryParams4, _options$apiVersion5, _options14, _CONTENT_TYPES$respon7;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam3 = (_options12 = options) === null || _options12 === void 0 ? void 0 : _options12.operationName) !== null && _options$operationNam3 !== void 0 ? _options$operationNam3 : 'patch';
...
function del(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options15, _options$responseType7, _options16, _queryParams5, _queryParams6, _options$apiVersion6, _options17, _CONTENT_TYPES$respon8;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam4 = (_options15 = options) === null || _options15 === void 0 ? void 0 : _options15.operationName) !== null && _options$operationNam4 !== void 0 ? _options$operationNam4 : 'delete';
    ...
    var responseType = (_options$responseType7 = (_options16 = options) === null || _options16 === void 0 ? void 0 : _options16.responseType) !== null && _options$responseType7 !== void 0 ? _options$responseType7 : 'json';
    var queryParams = params;
    ...
    var apiVersion = (_options$apiVersion6 = (_options17 = options) === null || _options17 === void 0 ? void 0 : _options17.apiVersion) !== null && _options$apiVersion6 !== void 0 ? _options$apiVersion6 : state.configuration.apiVersion;
    var headers = {
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam5, _options18, _options$replace, _options19, _options$responseType8, _options20, _params9, _options$apiVersion7, _options21, _CONTENT_TYPES$respon9;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam5 = (_options18 = options) === null || _options18 === void 0 ? void 0 : _options18.operationName) !== null && _options$operationNam5 !== void 0 ? _options$operationNam5 : 'upsert';
    ...
    var replace = (_options$replace = (_options19 = options) === null || _options19 === void 0 ? void 0 : _options19.replace) !== null && _options$replace !== void 0 ? _options$replace : false;
    var responseType = (_options$responseType8 = (_options20 = options) === null || _options20 === void 0 ? void 0 : _options20.responseType) !== null && _options$responseType8 !== void 0 ? _options$responseType8 : 'json';
