...
function log(operationName, apiVersion, url, resourceType) {
  ...
  (0, _Utils.logWaitingForServer)(url);
...
function create(resourceType, data, options, callback) {
  return state => {
    ...
    const operationName = (_expanded$options$ope = (_expanded$options = expanded.options) === null || _expanded$options === void 0 ? void 0 : _expanded$options.operationName) !== null && _expanded$options$ope !== void 0 ? _expanded$options$ope : 'create';
    ...
    const url = (0, _Utils.buildUrl)('/' + expanded.resourceType, hostUrl, apiVersion);
    ...
    return _axios.default.request({
      ...
      const reference = ((_result$data$response = result.data.response) === null || _result$data$response === void 0 ? void 0 : _result$data$response.importSummaries) ? result.data.response.importSummaries[0].href : (_result$data$response2 = result.data.response) === null || _result$data$response2 === void 0 ? void 0 : _result$data$response2.reference;

      _Utils.Log.info(`${operationName} succeeded. Created ${expanded.resourceType}: ${reference}.\nSummary:\n${(0, _Utils.prettyJson)(result.data)}`);
...
function update(resourceType, path, data, options, callback) {
  return state => {
    var _expanded$options$ope2, _expanded$options4, _expanded$options$res2, _expanded$options5, _expanded$options$api2, _expanded$options6;
    ...
    const operationName = (_expanded$options$ope2 = (_expanded$options4 = expanded.options) === null || _expanded$options4 === void 0 ? void 0 : _expanded$options4.operationName) !== null && _expanded$options$ope2 !== void 0 ? _expanded$options$ope2 : 'update';
    const responseType = (_expanded$options$res2 = (_expanded$options5 = expanded.options) === null || _expanded$options5 === void 0 ? void 0 : _expanded$options5.responseType) !== null && _expanded$options$res2 !== void 0 ? _expanded$options$res2 : 'json';
    const apiVersion = (_expanded$options$api2 = (_expanded$options6 = expanded.options) === null || _expanded$options6 === void 0 ? void 0 : _expanded$options6.apiVersion) !== null && _expanded$options$api2 !== void 0 ? _expanded$options$api2 : state.configuration.apiVersion;
...
function patch(resourceType, path, data, params, options, callback) {
  return state => {
    var _options$operationNam2, _options9, _options$responseType5, _options10, _queryParams3, _queryParams4, _options$apiVersion4, _options11, _CONTENT_TYPES$respon5;
...
function del(resourceType, path, data, params, options, callback) {
  return state => {
    var _options$operationNam3, _options12, _options$responseType6, _options13, _queryParams5, _queryParams6, _options$apiVersion5, _options14, _CONTENT_TYPES$respon6;
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return state => {
    var _options$operationNam4, _options15, _options$replace, _options16, _options$responseType7, _options17, _params7, _options$apiVersion6, _options18, _CONTENT_TYPES$respon7;
