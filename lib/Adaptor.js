...
function create(resourceType, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion5, _options$supportApiVe3, _CONTENT_TYPES$respon5;
...
function update(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion6, _options$supportApiVe4, _CONTENT_TYPES$respon6;
...
function patch(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion7, _options$supportApiVe5, _CONTENT_TYPES$respon7;
...
function del(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion8, _CONTENT_TYPES$respon8, _options$supportApiVe6;
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam, _options$replace, _options$responseType3, _options$apiVersion9, _CONTENT_TYPES$respon9;

    var operationName = (_options$operationNam = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam !== void 0 ? _options$operationNam : 'upsert';
