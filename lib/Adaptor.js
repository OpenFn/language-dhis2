...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    ...
    var preparedData = ['events', 'programs', 'trackedEntityInstances', 'enrollments', 'dataValueSets'].includes(resourceType) && isArray(data) ? _defineProperty({}, resourceType, data) : data;
    resourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
