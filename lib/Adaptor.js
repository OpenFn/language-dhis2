...
function createTEI(data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'createTEI');
    return create('trackedEntityInstances', data, params, expandedOptions, callback)(state);
  };
}
/**
...
function createEvent(data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'createEvents');
...
function createEvents(data, params, options, callback) {
  console.warn('This function is deprecated, consider using createEvent(data, params, options, callback).');
...
function createProgram(data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'createPrograms');
...
function createPrograms(data, params, options, callback) {
  console.warn('This function is deprecated, consider using createProgram(data, params, options, callback).');
...
function enrollTEI(data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'enrollTEI');
    return create('enrollments', data, expandedOptions, params, callback)(state);
  };
}
/**
...
function createDataValues(data, options, params, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'createDataValues');
    return create('dataValueSets', data, expandedOptions, params, callback)(state);
  };
}
/**
...
function getSchema(resourceType, params, options, callback) {
  return function (state) {
    var _options$responseType2, _options2, _params2, _params3, _options$apiVersion, _options3, _CONTENT_TYPES$respon2, _resourceType;
...
function getData(resourceType, params, options, callback) {
  return function (state) {
    var _options$operationNam, _options4, _options$responseType3, _options5, _params4, _params5, _params6, _options$apiVersion2, _options6, _CONTENT_TYPES$respon3;
...
function getMetadata(resources, params, options, callback) {
  return function (state) {
    var _options$responseType4, _options7, _queryParams, _queryParams2, _options$apiVersion3, _options8, _CONTENT_TYPES$respon4;
...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    var _options$operationNam2, _options9, _options$responseType5, _options10, _params7, _params8, _options$apiVersion4, _options11, _CONTENT_TYPES$respon5;

    resourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    var body = (0, _languageCommon.expandReferences)(data)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    params = (0, _languageCommon.expandReferences)(params)(state);
    var operationName = (_options$operationNam2 = (_options9 = options) === null || _options9 === void 0 ? void 0 : _options9.operationName) !== null && _options$operationNam2 !== void 0 ? _options$operationNam2 : 'create';
...
function update(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options12, _options$responseType6, _options13, _params9, _params10, _options$apiVersion5, _options14, _CONTENT_TYPES$respon6;
    ...
    var operationName = (_options$operationNam3 = (_options12 = options) === null || _options12 === void 0 ? void 0 : _options12.operationName) !== null && _options$operationNam3 !== void 0 ? _options$operationNam3 : 'update';
...
function patch(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options15, _options$responseType7, _options16, _queryParams3, _queryParams4, _options$apiVersion6, _options17, _CONTENT_TYPES$respon7;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam4 = (_options15 = options) === null || _options15 === void 0 ? void 0 : _options15.operationName) !== null && _options$operationNam4 !== void 0 ? _options$operationNam4 : 'patch';
...
function del(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam5, _options18, _options$responseType8, _options19, _queryParams5, _queryParams6, _options$apiVersion7, _options20, _CONTENT_TYPES$respon8;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam5 = (_options18 = options) === null || _options18 === void 0 ? void 0 : _options18.operationName) !== null && _options$operationNam5 !== void 0 ? _options$operationNam5 : 'delete';
    ...
    var responseType = (_options$responseType8 = (_options19 = options) === null || _options19 === void 0 ? void 0 : _options19.responseType) !== null && _options$responseType8 !== void 0 ? _options$responseType8 : 'json';
    var queryParams = params;
    ...
    var apiVersion = (_options$apiVersion7 = (_options20 = options) === null || _options20 === void 0 ? void 0 : _options20.apiVersion) !== null && _options$apiVersion7 !== void 0 ? _options$apiVersion7 : state.configuration.apiVersion;
    var headers = {
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam6, _options21, _options$replace, _options22, _options$responseType9, _options23, _params11, _options$apiVersion8, _options24, _CONTENT_TYPES$respon9;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam6 = (_options21 = options) === null || _options21 === void 0 ? void 0 : _options21.operationName) !== null && _options$operationNam6 !== void 0 ? _options$operationNam6 : 'upsert';
    ...
    var replace = (_options$replace = (_options22 = options) === null || _options22 === void 0 ? void 0 : _options22.replace) !== null && _options$replace !== void 0 ? _options$replace : false;
    var responseType = (_options$responseType9 = (_options23 = options) === null || _options23 === void 0 ? void 0 : _options23.responseType) !== null && _options$responseType9 !== void 0 ? _options$responseType9 : 'json';
