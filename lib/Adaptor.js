...
function getTEIs(params, options, callback) {
  return function (state) {
    ...
    var responseType = (_options$responseType = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType !== void 0 ? _options$responseType : 'json';
    return getData('trackedEntityInstances', params, responseType, options, callback)(state);
  };
}
/**
...
function getEvents(params, responseType, options, callback) {
  return function (state) {
...
function getPrograms(params, responseType, options, callback) {
  return function (state) {
...
function getEnrollments(params, responseType, options, callback) {
  return function (state) {
    return getData('enrollments', params, responseType, options, callback)(state);
  };
}
/**
...
function createEnrollment(data, params, options, callback) {
  return function (state) {
...
function getRelationships(params, responseType, options, callback) {
  return function (state) {
    return getData('relationships', params, responseType, options, callback)(state);
  };
}
/**
...
function getDataValues(params, responseType, options, callback) {
  return function (state) {
    return getData('dataValueSets', params, responseType, options, callback)(state);
  };
}
/**
...
function generateDhis2UID(params, responseType, options, callback) {
  return function (state) {
    return getData('system/id', params, responseType, options, callback)(state);
  };
}
/**
...
function getAnalytics(resourceType, params, responseType, options, callback) {
  return function (state) {
    return getData("analytics/".concat(resourceType), params, responseType, options, callback)(state);
  };
}
/**
...
function getResources(params, responseType, callback) {
  return function (state) {
    ...
    var queryParams = (0, _Utils.recursivelyExpandReferences)(params)(state);
...
function getSchema(resourceType, params, responseType, options, callback) {
  return function (state) {
    var _options$apiVersion2, _options$supportApiVe, _CONTENT_TYPES$respon2;
...
function getData(resourceType, params, options, callback) {
  return function (state) {
    var _options$responseType2, _options$apiVersion3, _CONTENT_TYPES$respon3;
    ...
    var _state$configuration5 = state.configuration,
        ...
        hostUrl = _state$configuration5.hostUrl; // NOTE: 'filters' is the only special parameter we control for DHIS2, all
    ...
    var responseType = (_options$responseType2 = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType2 !== void 0 ? _options$responseType2 : 'json';
...
function getMetadata(resources, params, responseType, options, callback) {
  return function (state) {
    var _options$apiVersion4, _options$supportApiVe2, _CONTENT_TYPES$respon4;
    ...
    var queryParams = (0, _Utils.recursivelyExpandReferences)(_objectSpread({}, resources, {}, params))(state);
...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    var _options$operationNam, _options$responseType3, _options$apiVersion5, _CONTENT_TYPES$respon5;

    var operationName = (_options$operationNam = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam !== void 0 ? _options$operationNam : 'create';
    ...
    var responseType = (_options$responseType3 = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType3 !== void 0 ? _options$responseType3 : 'json';
...
function update(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam2, _options$responseType4, _options$apiVersion6, _CONTENT_TYPES$respon6;

    var operationName = (_options$operationNam2 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam2 !== void 0 ? _options$operationNam2 : 'update';
    ...
    var responseType = (_options$responseType4 = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType4 !== void 0 ? _options$responseType4 : 'json';
    var filters = params === null || params === void 0 ? void 0 : params.filters;
...
function patch(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options$responseType5, _queryParams, _queryParams2, _options$apiVersion7, _CONTENT_TYPES$respon7;

    var operationName = (_options$operationNam3 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam3 !== void 0 ? _options$operationNam3 : 'patch';
    ...
    var responseType = (_options$responseType5 = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType5 !== void 0 ? _options$responseType5 : 'json';
    var queryParams = (0, _Utils.recursivelyExpandReferences)(params)(state);
...
function del(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options$responseType6, _queryParams3, _queryParams4, _options$apiVersion8, _CONTENT_TYPES$respon8;

    var operationName = (_options$operationNam4 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam4 !== void 0 ? _options$operationNam4 : 'delete';
    ...
    var responseType = (_options$responseType6 = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType6 !== void 0 ? _options$responseType6 : 'json';
    var queryParams = (0, _Utils.recursivelyExpandReferences)(params)(state);
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam5, _options$replace, _options$responseType7, _options$apiVersion9, _CONTENT_TYPES$respon9;

    var operationName = (_options$operationNam5 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam5 !== void 0 ? _options$operationNam5 : 'upsert';
    ...
    var responseType = (_options$responseType7 = options === null || options === void 0 ? void 0 : options.responseType) !== null && _options$responseType7 !== void 0 ? _options$responseType7 : 'json';

    var _recursivelyExpandRef = (0, _Utils.recursivelyExpandReferences)(uniqueAttribute)(state),
        attributeId = _recursivelyExpandRef.attributeId,
        attributeValue = _recursivelyExpandRef.attributeValue;

    params = (0, _Utils.recursivelyExpandReferences)(params)(state);
    var _params2 = params,
        filters = _params2.filters;
    delete params.filters;
    var queryParams = new URLSearchParams(params);
    filters === null || filters === void 0 ? void 0 : filters.map(function (f) {
      return queryParams.append('filter', f);
