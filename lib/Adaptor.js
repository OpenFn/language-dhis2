...
function getData(resourceType, params, responseType, options, callback) {
  return function (state) {
    var _options$apiVersion3, _options$supportApiVe2, _CONTENT_TYPES$respon3;
...
function getMetadata(resources, params, responseType, options, callback) {
  return function (state) {
    var _options$apiVersion4, _options$supportApiVe3, _CONTENT_TYPES$respon4;
...
function create(resourceType, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion5, _options$supportApiVe4, _CONTENT_TYPES$respon5;
...
function update(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion6, _options$supportApiVe5, _CONTENT_TYPES$respon6;
...
function patch(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion7, _options$supportApiVe6, _CONTENT_TYPES$respon7;
...
function del(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion8, _CONTENT_TYPES$respon8, _options$supportApiVe7;
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$replace, _options$responseType, _options$apiVersion9, _CONTENT_TYPES$respon9;
