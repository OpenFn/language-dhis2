...
function create(resourceType, data, options = {}, callback = false) {
  return state => {
...
function update(resourceType, path, data, options = {}, callback = false) {
  return state => {
...
function get(resourceType, query, options = {}, callback = false) {
  return state => {
    console.log('Preparing get operation...');
    resourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    query = (0, _languageCommon.expandReferences)(query)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    const {
      params,
      requestConfig
...
function upsert(resourceType, query, data, options = {}, callback = false) {
  return state => {
    console.log(`Preparing upsert via 'get' then 'create' OR 'update'...`);
    return get(resourceType, query)(state).then(resp => {
...
function findAttributeValue(trackedEntityInstance, attributeDisplayName) {
  var _trackedEntityInstanc, _trackedEntityInstanc2;

  return trackedEntityInstance === null || trackedEntityInstance === void 0 ? void 0 : (_trackedEntityInstanc = trackedEntityInstance.attributes) === null || _trackedEntityInstanc === void 0 ? void 0 : (_trackedEntityInstanc2 = _trackedEntityInstanc.find(a => (a === null || a === void 0 ? void 0 : a.displayName.toLowerCase()) == attributeDisplayName.toLowerCase())) === null || _trackedEntityInstanc2 === void 0 ? void 0 : _trackedEntityInstanc2.value;
}
/**
