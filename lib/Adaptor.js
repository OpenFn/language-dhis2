...
function update(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion6, _options$supportApiVe3, _CONTENT_TYPES$respon6;
    ...
    (0, _Utils.logOperation)("UPDATE ".concat(resourceType));
    (0, _Utils.logApiVersion)(apiVersion, supportApiVersion);
    (0, _Utils.logWaitingForServer)(url, queryParams);
    (0, _Utils.warnExpectLargeResult)(resourceType, url);
    return _axios["default"].request({
...
function patch(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion7, _options$supportApiVe4, _CONTENT_TYPES$respon7;
...
function del(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion8, _CONTENT_TYPES$respon8, _options$supportApiVe5;
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam2, _options$replace, _options$responseType4, _options$apiVersion9, _CONTENT_TYPES$respon9;

    var operationName = (_options$operationNam2 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam2 !== void 0 ? _options$operationNam2 : 'upsert';
