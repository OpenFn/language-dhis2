...
function patch(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion7, _options$supportApiVe3, _CONTENT_TYPES$respon7;
...
function del(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion8, _CONTENT_TYPES$respon8, _options$supportApiVe4;
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options$replace, _options$responseType5, _options$apiVersion9, _CONTENT_TYPES$respon9;

    var operationName = (_options$operationNam3 = options === null || options === void 0 ? void 0 : options.operationName) !== null && _options$operationNam3 !== void 0 ? _options$operationNam3 : 'upsert';
