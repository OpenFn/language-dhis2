...
function getResources(params, options, callback) {
  return function (state) {
    ...
    return _axios["default"].request({
      ...
      responseType: _utils_lang_dhis.MEDIA_TYPES.JSON,
      transformResponse: [function (data, headers) {
        var _headers$HTTP_HEADERS, _headers$HTTP_HEADERS2;

        if ((_headers$HTTP_HEADERS = (_headers$HTTP_HEADERS2 = headers[_utils_lang_dhis.HTTP_HEADERS.CONTENT_TYPE]) === null || _headers$HTTP_HEADERS2 === void 0 ? void 0 : _headers$HTTP_HEADERS2.split(_utils_lang_dhis.PUNCTUATIONS.SEMI_COLON)[0]) !== null && _headers$HTTP_HEADERS !== void 0 ? _headers$HTTP_HEADERS : null === _utils_lang_dhis.CONTENT_TYPES.APPLICATION_JSON) {
...
function getData(resourceType, params, options, callback) {
  return function (state) {
    var _state$configuration4 = state === null || state === void 0 ? void 0 : state.configuration,
        username = _state$configuration4.username,
        password = _state$configuration4.password;

    var url = (0, _utils_lang_dhis.buildUrl)(getData, resourceType, state === null || state === void 0 ? void 0 : state.configuration, options);
    (0, _utils_lang_dhis.logApiVersion)(state.configuration, options);
    (0, _utils_lang_dhis.logWaitingForServer)(url, params);
    (0, _utils_lang_dhis.warnExpectLargeResult)(resourceType, url);
    return _axios["default"].request({
      ...
      _utils_lang_dhis.Log.info((0, _utils_lang_dhis.composeSuccessMessage)(getData, resourceType, params, options, callback));
...
function getMetadata(resources, params, options, callback) {
  return function (state) {
    ...
    var url = (0, _utils_lang_dhis.buildUrl)(getMetadata, resources, state === null || state === void 0 ? void 0 : state.configuration, options);
    (0, _utils_lang_dhis.logApiVersion)(state.configuration, options);
    (0, _utils_lang_dhis.logWaitingForServer)(url, queryParams);
    (0, _utils_lang_dhis.warnExpectLargeResult)(resources, url);
    return _axios["default"].request({
      method: _utils_lang_dhis.HTTP_METHODS.GET,
      url: url,
      auth: {
      ...
      _utils_lang_dhis.Log.info((0, _utils_lang_dhis.composeSuccessMessage)(getMetadata, resources, queryParams, options, callback));
