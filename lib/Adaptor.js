...
function getData(resourceType, params, options, callback) {
  return function (state) {
    var _options$operationNam, _options6, _options$responseType3, _options7, _params4, _params5, _params6, _options$apiVersion3, _options8, _CONTENT_TYPES$respon3;
...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    var _options$operationNam2, _options11, _options$responseType5, _options12, _params7, _params8, _options$apiVersion5, _options13, _CONTENT_TYPES$respon5;
...
function update(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options14, _options$responseType6, _options15, _params9, _params10, _options$apiVersion6, _options16, _CONTENT_TYPES$respon6;
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam6, _options23, _options$replace, _options24, _options$responseType9, _options25, _params11, _options$apiVersion9, _options26, _CONTENT_TYPES$respon9;
