...
function execute(...operations) {
  ...
  return state => {
    return (0, _languageCommon.execute)(
...
_axios.default.interceptors.response.use(
  function (response) {
    ...
    const contentType =
      (_response$headers$con = response.headers['content-type']) === null ||
      _response$headers$con === void 0
        ? void 0
        : _response$headers$con.split(';')[0];
    ...
    if (
      typeof ((_response = response) === null || _response === void 0
        ? void 0
        : _response.data) === 'string' &&
      contentType ===
        (_Utils.CONTENT_TYPES === null || _Utils.CONTENT_TYPES === void 0
          ? void 0
          : _Utils.CONTENT_TYPES.json)
    ) {
      try {
...
function create(resourceType, data, options, callback) {
  ...
  return state => {
    ...
    const { resourceType, data, options } = (0,
    _languageCommon.expandReferences)(initialParams)(state);
    const apiVersion =
      (_options$apiVersion =
        options === null || options === void 0
          ? void 0
          : options.apiVersion) !== null && _options$apiVersion !== void 0
        ? _options$apiVersion
    ...
    return _axios.default
      ...
      .then(result => {
        ...
        if (callback)
          return callback(
            (0, _languageCommon.composeNextState)(state, result.data)
          );
...
function update(resourceType, path, data, options, callback) {
  return state => {
    var _expanded$options$ope,
      _expanded$options,
      _expanded$options$res,
      _expanded$options2,
      _expanded$options$api,
      _expanded$options3;
    ...
    const { username, password, hostUrl } = state.configuration;
    const operationName =
      (_expanded$options$ope =
        (_expanded$options = expanded.options) === null ||
        _expanded$options === void 0
          ? void 0
          : _expanded$options.operationName) !== null &&
      _expanded$options$ope !== void 0
        ? _expanded$options$ope
        : 'update';
    const responseType =
      (_expanded$options$res =
        (_expanded$options2 = expanded.options) === null ||
        _expanded$options2 === void 0
          ? void 0
          : _expanded$options2.responseType) !== null &&
      _expanded$options$res !== void 0
        ? _expanded$options$res
        : 'json';
    const apiVersion =
      (_expanded$options$api =
        (_expanded$options3 = expanded.options) === null ||
        _expanded$options3 === void 0
          ? void 0
          : _expanded$options3.apiVersion) !== null &&
      _expanded$options$api !== void 0
        ? _expanded$options$api
        : state.configuration.apiVersion;
    const url = (0, _Utils.buildUrl)(
...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return state => {
    var _expandedOptions$apiV,
      _expandedOptions$stri,
      _body$attributes,
      _body$attributes$find;

    uniqueAttributeId = (0, _languageCommon.expandReferences)(
      uniqueAttributeId
    )(state);
    ...
    const apiVersion =
      (_expandedOptions$apiV =
        expandedOptions === null || expandedOptions === void 0
          ? void 0
          : expandedOptions.apiVersion) !== null &&
      _expandedOptions$apiV !== void 0
        ? _expandedOptions$apiV
        : state.configuration.apiVersion;
    const strict =
      (_expandedOptions$stri =
        expandedOptions === null || expandedOptions === void 0
          ? void 0
          : expandedOptions.strict) !== null && _expandedOptions$stri !== void 0
        ? _expandedOptions$stri
        : true;
    const params = {
      ou: body.orgUnit,
    };
    const uniqueAttributeValue =
      (_body$attributes = body.attributes) === null ||
      _body$attributes === void 0
        ? void 0
        : (_body$attributes$find = _body$attributes.find(
            obj =>
              (obj === null || obj === void 0 ? void 0 : obj.attribute) ===
              uniqueAttributeId
          )) === null || _body$attributes$find === void 0
        ? void 0
        : _body$attributes$find.value;
    const trackedEntityType = body.trackedEntityType;
    const uniqueAttributeUrl = (0, _Utils.buildUrl)(
      `/trackedEntityAttributes/${uniqueAttributeId}`,
      hostUrl,
      apiVersion
    );
    const trackedEntityTypeUrl = (0, _Utils.buildUrl)(
    ...
    const findTrackedEntityType = () => {
      return _axios.default
        ...
        .then(result => {
          ...
          const attribute =
            (_result$data = result.data) === null || _result$data === void 0
              ? void 0
              : (_result$data$trackedE =
                  _result$data.trackedEntityTypeAttributes) === null ||
                _result$data$trackedE === void 0
              ? void 0
              : _result$data$trackedE.find(obj => {
                  var _obj$trackedEntityAtt;

                  return (
                    (obj === null || obj === void 0
                      ? void 0
                      : (_obj$trackedEntityAtt = obj.trackedEntityAttribute) ===
                          null || _obj$trackedEntityAtt === void 0
                      ? void 0
                      : _obj$trackedEntityAtt.id) === uniqueAttributeId
                  );
                });
          return {
            ...result.data,
    ...
    return Promise.all([
      ...
      if (!attribute.unique) {
        ...
        throw new RangeError(
          `Attribute ${
            (_attribute$name = attribute.name) !== null &&
            _attribute$name !== void 0
              ? _attribute$name
              : ''
              ...
              return {
                ...
                parameters: filteredData.parameters.reduce(
                  (acc, currentValue) => {
                    ...
                    let descIndex;
                    if (
                      (0, _lodash.indexOf)(param.description, ',') === -1 &&
                      (0, _lodash.indexOf)(param.description, '.') > -1
                    )
                      descIndex = (0, _lodash.indexOf)(param.description, '.');
                    else if (
                      (0, _lodash.indexOf)(param.description, ',') > -1 &&
                      (0, _lodash.indexOf)(param.description, '.') > -1
                    ) {
                      descIndex =
                        (0, _lodash.indexOf)(param.description, '.') <
                        (0, _lodash.indexOf)(param.description, ',')
                          ? (0, _lodash.indexOf)(param.description, '.')
                          : (0, _lodash.indexOf)(param.description, ',');
                    } else {
      ...
      .then(result => {
        ...
        _Utils.Log.info(
          `\t=======================================================================================\n\tQuery Parameters for ${httpMethod} on ${endpoint} [${
            (_result$data$descript = result.data.description) !== null &&
            _result$data$descript !== void 0
              ? _result$data$descript
              : '<description_missing>'
          }]\n\t=======================================================================================`
        );
    ...
    const responseType =
      (_options$responseType =
        (_options = options) === null || _options === void 0
          ? void 0
          : _options.responseType) !== null && _options$responseType !== void 0
        ? _options$responseType
        : 'json';
    const filter =
      (_params = params) === null || _params === void 0
        ? void 0
        : _params.filter;
    const queryParams = params;
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon = _Utils.CONTENT_TYPES[responseType]) !== null &&
        _CONTENT_TYPES$respon !== void 0
          ? _CONTENT_TYPES$respon
          : 'application/json',
    };
      ...
      if (filter) {
        ...
        if (
          ((_headers$contentType =
            (_headers$contentType2 = headers['content-type']) === null ||
            _headers$contentType2 === void 0
              ? void 0
              : _headers$contentType2.split(';')[0]) !== null &&
          _headers$contentType !== void 0
            ? _headers$contentType
            : null) === _Utils.CONTENT_TYPES.json
        ) {
          let tempData = JSON.parse(data);
          return {
            ...tempData,
            resources: (0, _Utils.applyFilter)(
              tempData.resources,
              ...(0, _Utils.parseFilter)(filter)
            ),
          };
        } else {
          _Utils.Log.warn(
...
function getSchema(resourceType, params, options, callback) {
  return state => {
    var _options$responseType2,
      _options2,
      _params2,
      _params3,
      _options$apiVersion2,
      _options3,
      _CONTENT_TYPES$respon2,
      _resourceType;
    ...
    const { username, password, hostUrl } = state.configuration;
    const responseType =
      (_options$responseType2 =
        (_options2 = options) === null || _options2 === void 0
          ? void 0
          : _options2.responseType) !== null &&
      _options$responseType2 !== void 0
        ? _options$responseType2
        : 'json';
    const filters =
      (_params2 = params) === null || _params2 === void 0
        ? void 0
        : _params2.filters;
    (_params3 = params) === null || _params3 === void 0
      ? true
      : delete _params3.filters;
    ...
    const apiVersion =
      (_options$apiVersion2 =
        (_options3 = options) === null || _options3 === void 0
          ? void 0
          : _options3.apiVersion) !== null && _options$apiVersion2 !== void 0
        ? _options$apiVersion2
        : state.configuration.apiVersion;
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon2 = _Utils.CONTENT_TYPES[responseType]) !==
          null && _CONTENT_TYPES$respon2 !== void 0
          ? _CONTENT_TYPES$respon2
          : 'application/json',
    };
    const url = (0, _Utils.buildUrl)(
      `/schemas/${
        (_resourceType = resourceType) !== null && _resourceType !== void 0
          ? _resourceType
          : ''
      }`,
      hostUrl,
...
function getData(resourceType, params, options, callback) {
  return state => {
    var _options$operationNam,
      _options4,
      _options$responseType3,
      _options5,
      _params4,
      _params5,
      _params6,
      _options$apiVersion3,
      _options6,
      _CONTENT_TYPES$respon3;

    resourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    const operationName =
      (_options$operationNam =
        (_options4 = options) === null || _options4 === void 0
          ? void 0
          : _options4.operationName) !== null &&
      _options$operationNam !== void 0
        ? _options$operationNam
        : 'getData';
    const { username, password, hostUrl } = state.configuration;
    const responseType =
      (_options$responseType3 =
        (_options5 = options) === null || _options5 === void 0
          ? void 0
          : _options5.responseType) !== null &&
      _options$responseType3 !== void 0
        ? _options$responseType3
        : 'json';
    const filters =
      (_params4 = params) === null || _params4 === void 0
        ? void 0
        : _params4.filters;
    const dimensions =
      (_params5 = params) === null || _params5 === void 0
        ? void 0
        : _params5.dimensions;
    (_params6 = params) === null || _params6 === void 0
      ? true
      : delete _params6.filters;
    let queryParams = new URLSearchParams(params);
    filters === null || filters === void 0
      ? void 0
      : filters.map(f => queryParams.append('filter', f));
    ...
    const apiVersion =
      (_options$apiVersion3 =
        (_options6 = options) === null || _options6 === void 0
          ? void 0
          : _options6.apiVersion) !== null && _options$apiVersion3 !== void 0
        ? _options$apiVersion3
        : state.configuration.apiVersion;
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon3 = _Utils.CONTENT_TYPES[responseType]) !==
          null && _CONTENT_TYPES$respon3 !== void 0
          ? _CONTENT_TYPES$respon3
          : 'application/json',
    };
    const url = (0, _Utils.buildUrl)(`/${resourceType}`, hostUrl, apiVersion);
...
function getMetadata(resources, params, options, callback) {
  return state => {
    var _options$responseType4,
      _options7,
      _queryParams,
      _queryParams2,
      _options$apiVersion4,
      _options8,
      _CONTENT_TYPES$respon4;
    ...
    const { username, password, hostUrl } = state.configuration;
    const responseType =
      (_options$responseType4 =
        (_options7 = options) === null || _options7 === void 0
          ? void 0
          : _options7.responseType) !== null &&
      _options$responseType4 !== void 0
        ? _options$responseType4
        : 'json';
    ...
    let queryParams = { ...resources, ...params };
    const filters =
      (_queryParams = queryParams) === null || _queryParams === void 0
        ? void 0
        : _queryParams.filters;
    (_queryParams2 = queryParams) === null || _queryParams2 === void 0
      ? true
      : delete _queryParams2.filters;
    ...
    const apiVersion =
      (_options$apiVersion4 =
        (_options8 = options) === null || _options8 === void 0
          ? void 0
          : _options8.apiVersion) !== null && _options$apiVersion4 !== void 0
        ? _options$apiVersion4
        : state.configuration.apiVersion;
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon4 = _Utils.CONTENT_TYPES[responseType]) !==
          null && _CONTENT_TYPES$respon4 !== void 0
          ? _CONTENT_TYPES$respon4
          : 'application/json',
    };
...
function patch(resourceType, path, data, params, options, callback) {
  return state => {
    var _options$operationNam2,
      _options9,
      _options$responseType5,
      _options10,
      _queryParams3,
      _queryParams4,
      _options$apiVersion5,
      _options11,
      _CONTENT_TYPES$respon5;
    ...
    options = (0, _languageCommon.expandReferences)(options)(state);
    const operationName =
      (_options$operationNam2 =
        (_options9 = options) === null || _options9 === void 0
          ? void 0
          : _options9.operationName) !== null &&
      _options$operationNam2 !== void 0
        ? _options$operationNam2
        : 'patch';
    const { username, password, hostUrl } = state.configuration;
    const responseType =
      (_options$responseType5 =
        (_options10 = options) === null || _options10 === void 0
          ? void 0
          : _options10.responseType) !== null &&
      _options$responseType5 !== void 0
        ? _options$responseType5
        : 'json';
    let queryParams = params;
    const filters =
      (_queryParams3 = queryParams) === null || _queryParams3 === void 0
        ? void 0
        : _queryParams3.filters;
    (_queryParams4 = queryParams) === null || _queryParams4 === void 0
      ? true
      : delete _queryParams4.filters;
    queryParams = new URLSearchParams(queryParams);
    filters === null || filters === void 0
      ? void 0
      : filters.map(f => queryParams.append('filter', f));
    const apiVersion =
      (_options$apiVersion5 =
        (_options11 = options) === null || _options11 === void 0
          ? void 0
          : _options11.apiVersion) !== null && _options$apiVersion5 !== void 0
        ? _options$apiVersion5
        : state.configuration.apiVersion;
    const url = (0, _Utils.buildUrl)(
      '/' + resourceType + '/' + path,
    ...
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon5 = _Utils.CONTENT_TYPES[responseType]) !==
          null && _CONTENT_TYPES$respon5 !== void 0
          ? _CONTENT_TYPES$respon5
          : 'application/json',
    };
    (0, _Utils.logOperation)(operationName);
    ...
    return _axios.default
      ...
      .then(result => {
        ...
        _Utils.Log.info(
          ...
          _Utils.prettyJson)(resultObject)}`
        );

        if (callback)
          return callback(
            (0, _languageCommon.composeNextState)(state, resultObject)
          );
...
function del(resourceType, path, data, params, options, callback) {
  return state => {
    var _options$operationNam3,
      _options12,
      _options$responseType6,
      _options13,
      _queryParams5,
      _queryParams6,
      _options$apiVersion6,
      _options14,
      _CONTENT_TYPES$respon6;
    ...
    options = (0, _languageCommon.expandReferences)(options)(state);
    const operationName =
      (_options$operationNam3 =
        (_options12 = options) === null || _options12 === void 0
          ? void 0
          : _options12.operationName) !== null &&
      _options$operationNam3 !== void 0
        ? _options$operationNam3
        : 'delete';
    const { username, password, hostUrl } = state.configuration;
    const responseType =
      (_options$responseType6 =
        (_options13 = options) === null || _options13 === void 0
          ? void 0
          : _options13.responseType) !== null &&
      _options$responseType6 !== void 0
        ? _options$responseType6
        : 'json';
    let queryParams = params;
    const filters =
      (_queryParams5 = queryParams) === null || _queryParams5 === void 0
        ? void 0
        : _queryParams5.filters;
    (_queryParams6 = queryParams) === null || _queryParams6 === void 0
      ? true
      : delete _queryParams6.filters;
    queryParams = new URLSearchParams(queryParams);
    filters === null || filters === void 0
      ? void 0
      : filters.map(f => queryParams.append('filter', f));
    const apiVersion =
      (_options$apiVersion6 =
        (_options14 = options) === null || _options14 === void 0
          ? void 0
          : _options14.apiVersion) !== null && _options$apiVersion6 !== void 0
        ? _options$apiVersion6
        : state.configuration.apiVersion;
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon6 = _Utils.CONTENT_TYPES[responseType]) !==
          null && _CONTENT_TYPES$respon6 !== void 0
          ? _CONTENT_TYPES$respon6
          : 'application/json',
    };
    const url = (0, _Utils.buildUrl)(
...
function upsert(
  ...
  return state => {
    var _options$operationNam4,
      _options15,
      _options$replace,
      _options16,
      _options$responseType7,
      _options17,
      _params7,
      _options$apiVersion7,
      _options18,
      _CONTENT_TYPES$respon7;

    resourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    uniqueAttribute = (0, _languageCommon.expandReferences)(uniqueAttribute)(
      state
    );
    const body = (0, _languageCommon.expandReferences)(data)(state);
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    const operationName =
      (_options$operationNam4 =
        (_options15 = options) === null || _options15 === void 0
          ? void 0
          : _options15.operationName) !== null &&
      _options$operationNam4 !== void 0
        ? _options$operationNam4
        : 'upsert';
    const { username, password, hostUrl } = state.configuration;
    const replace =
      (_options$replace =
        (_options16 = options) === null || _options16 === void 0
          ? void 0
          : _options16.replace) !== null && _options$replace !== void 0
        ? _options$replace
        : false;
    const responseType =
      (_options$responseType7 =
        (_options17 = options) === null || _options17 === void 0
          ? void 0
          : _options17.responseType) !== null &&
      _options$responseType7 !== void 0
        ? _options$responseType7
        : 'json';
    const { attributeId, attributeValue } = uniqueAttribute;
    const filters =
      (_params7 = params) === null || _params7 === void 0
        ? void 0
        : _params7.filters;
    ...
    const apiVersion =
      (_options$apiVersion7 =
        (_options18 = options) === null || _options18 === void 0
          ? void 0
          : _options18.apiVersion) !== null && _options$apiVersion7 !== void 0
        ? _options$apiVersion7
        : state.configuration.apiVersion;
    const url = (0, _Utils.buildUrl)('/' + resourceType, hostUrl, apiVersion);
    const headers = {
      Accept:
        (_CONTENT_TYPES$respon7 = _Utils.CONTENT_TYPES[responseType]) !==
          null && _CONTENT_TYPES$respon7 !== void 0
          ? _CONTENT_TYPES$respon7
          : 'application/json',
    };
    (0, _Utils.logOperation)(operationName);
          ...
          transformResponse: [
            function (data, headers) {
              ...
              if (filter) {
                ...
                if (
                  ((_headers$contentType3 =
                    (_headers$contentType4 = headers['content-type']) ===
                      null || _headers$contentType4 === void 0
                      ? void 0
                      : _headers$contentType4.split(';')[0]) !== null &&
                  _headers$contentType3 !== void 0
                    ? _headers$contentType3
                    : null) === _Utils.CONTENT_TYPES.json
                ) {
                  let tempData = JSON.parse(data);
    ...
    return Promise.all([
      ...
      if (recordsWithValueCount > 1) {
        ...
        const method = replace
          ...
          : 'PATCH';
        const id =
          (_row1$id = row1['id']) !== null && _row1$id !== void 0
            ? _row1$id
            : row1[resourceName];
        ...
        _Utils.Log.info(
          `Existing record not found, proceeding to CREATE(POST) ...`
            ...
            _Utils.Log.info(
              `${operationName} succeeded. Created ${resourceName}: ${
                result.data.response.importSummaries
                  ...
                  : (_result$data$response = result.data.response) === null ||
                    _result$data$response === void 0
                  ? void 0
                  : _result$data$response.reference
              }.\nSummary:\n${(0, _Utils.prettyJson)(result.data)}`
            );
...
function attrVal(tei, attributeName) {
  ...
  return tei === null || tei === void 0
    ? void 0
    : (_tei$attributes = tei.attributes) === null || _tei$attributes === void 0
    ? void 0
    : (_tei$attributes$find = _tei$attributes.find(
        a =>
          (a === null || a === void 0 ? void 0 : a.displayName.toLowerCase()) ==
          attributeName.toLowerCase()
      )) === null || _tei$attributes$find === void 0
    ? void 0
    : _tei$attributes$find.value;
}
