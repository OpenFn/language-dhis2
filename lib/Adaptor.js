...
function getMetadata(resources, params, options, callback) {
  return function (state) {
    var _options$responseType4, _options9, _queryParams, _queryParams2, _options$apiVersion4, _options10, _CONTENT_TYPES$respon4;
...
function patch(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options17, _options$responseType7, _options18, _queryParams3, _queryParams4, _options$apiVersion7, _options19, _CONTENT_TYPES$respon7;
...
function del(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam5, _options20, _options$responseType8, _options21, _queryParams5, _queryParams6, _options$apiVersion8, _options22, _CONTENT_TYPES$respon8;
