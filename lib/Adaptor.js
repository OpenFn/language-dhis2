...
function create(resourceType, data, options, params, callback) {
  return function (state) {
    var _expandedOptions$oper, _expandedOptions$resp, _expandedOptions$apiV, _CONTENT_TYPES$respon;

    if (isArray(data) && resourceType === 'programs') {
      _Utils.Log.warn("DHIS2 doesn't allow creation of multiple programs at once.");

      return state;
    }

    var expandedData = (0, _languageCommon.expandReferences)(data)(state);
    var body = isArray(expandedData) ? _defineProperty({}, resourceType, expandedData) : expandedData;
    var expandedResourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    var expandedOptions = (0, _languageCommon.expandReferences)(options)(state);
    var expandedParams = (0, _languageCommon.expandReferences)(params)(state);
    var operationName = (_expandedOptions$oper = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.operationName) !== null && _expandedOptions$oper !== void 0 ? _expandedOptions$oper : 'create';
    ...
    var responseType = (_expandedOptions$resp = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.responseType) !== null && _expandedOptions$resp !== void 0 ? _expandedOptions$resp : 'json';
    expandedParams === null || expandedParams === void 0 ? true : delete expandedParams.filters;
    var queryParams = new URLSearchParams(expandedParams);
    var apiVersion = (_expandedOptions$apiV = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.apiVersion) !== null && _expandedOptions$apiV !== void 0 ? _expandedOptions$apiV : state.configuration.apiVersion;
    var url = (0, _Utils.buildUrl)('/' + expandedResourceType, hostUrl, apiVersion);
    var headers = {
    ...
    (0, _Utils.warnExpectLargeResult)(expandedResourceType, url);
...
function update(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _expandedOptions$oper2, _expandedOptions$apiV2, _CONTENT_TYPES$expand;

    var expandedResourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    var expandedPath = (0, _languageCommon.expandReferences)(path)(state);
    ...
    var operationName = (_expandedOptions$oper2 = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.operationName) !== null && _expandedOptions$oper2 !== void 0 ? _expandedOptions$oper2 : 'update';
    var filters = expandedParams === null || expandedParams === void 0 ? void 0 : expandedParams.filters;
    expandedParams === null || expandedParams === void 0 ? true : delete expandedParams.filters;
    var queryParams = new URLSearchParams(expandedParams);
    filters === null || filters === void 0 ? void 0 : filters.map(function (f) {
      return queryParams.append('filter', f);
    });
    var apiVersion = (_expandedOptions$apiV2 = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.apiVersion) !== null && _expandedOptions$apiV2 !== void 0 ? _expandedOptions$apiV2 : state.configuration.apiVersion;
    var url = (0, _Utils.buildUrl)('/' + expandedResourceType + '/' + expandedPath, hostUrl, apiVersion);
    var headers = {
      Accept: (_CONTENT_TYPES$expand = _Utils.CONTENT_TYPES[expandedResourceType]) !== null && _CONTENT_TYPES$expand !== void 0 ? _CONTENT_TYPES$expand : 'application/json'
    };
    (0, _Utils.logOperation)(operationName);
    (0, _Utils.logApiVersion)(apiVersion);
    (0, _Utils.logWaitingForServer)(url, queryParams);
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info("".concat(operationName, " succeeded. Updated ").concat(expandedResourceType, ".\nSummary:\n").concat((0, _Utils.prettyJson)(result.data)));
...
function getTEIs(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getTEIs');
...
function upsertTEI(uniqueAttributeId, data, options, callback) {
  return function (state) {
    var _expandedOptions$apiV3, _expandedOptions$stri, _body$attributes, _body$attributes$find;

    uniqueAttributeId = (0, _languageCommon.expandReferences)(uniqueAttributeId)(state);
    var body = (0, _languageCommon.expandReferences)(data)(state);
    var expandedOptions = expandAndSetOperation(options, state, 'upsertTEI');
    ...
    var apiVersion = (_expandedOptions$apiV3 = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.apiVersion) !== null && _expandedOptions$apiV3 !== void 0 ? _expandedOptions$apiV3 : state.configuration.apiVersion;
    var strict = (_expandedOptions$stri = expandedOptions === null || expandedOptions === void 0 ? void 0 : expandedOptions.strict) !== null && _expandedOptions$stri !== void 0 ? _expandedOptions$stri : true;
    var params = {
      ou: body.orgUnit
    };
...
function updateTEI(path, data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'updateTEI');
    return update('trackedEntityInstances', path, data, params, expandedOptions, callback)(state);
  };
}
/**
...
function getEvents(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getEvents');
...
function updateEvents(path, data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'updateEvents');
    return update('events', path, data, params, expandedOptions, callback)(state);
  };
}
/**
...
function getPrograms(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getPrograms');
...
function updatePrograms(path, data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'updatePrograms');
    return update('programs', path, data, params, expandedOptions, callback)(state);
  };
}
/**
...
function getEnrollments(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getEnrollments');
...
function updateEnrollments(path, data, params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'updateEnrollments');
...
function cancelEnrollment(enrollmentId, params, options, callback) {
  return function (state) {
    ...
    var expandedOptions = expandAndSetOperation(options, state, 'cancelEnrollment');
...
function completeEnrollment(enrollmentId, params, options, callback) {
  return function (state) {
    ...
    var expandedOptions = expandAndSetOperation(options, state, 'enrollments');
    return update('enrollments', path, null, params, expandedOptions, callback)(state);
  };
}
/**
...
function getRelationships(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getRelationships');
...
function getDataValues(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getDataValues');
...
function generateDhis2UID(options, callback) {
  return function (state) {
    ...
    var expandedOptions = expandAndSetOperation(options, state, 'generateDhis2UID');
    var limit = {
...
function discover(httpMethod, endpoint) {
  return function (state) {
    _Utils.Log.info("Discovering query/import parameters for ".concat(httpMethod, " on ").concat(endpoint));
    ...
    return _axios["default"].get('https://dhis2.github.io/dhis2-api-specification/spec/metadata_openapi.json', {
      ...
      _Utils.Log.info("\t=======================================================================================\n\tQuery Parameters for ".concat(httpMethod, " on ").concat(endpoint, " [").concat((_result$data$descript = result.data.description) !== null && _result$data$descript !== void 0 ? _result$data$descript : '<description_missing>', "]\n\t======================================================================================="));
...
function getAnalytics(params, options, callback) {
  return function (state) {
    var expandedOptions = expandAndSetOperation(options, state, 'getAnalytics');
...
function getResources(params, options, callback) {
  return function (state) {
    var _options$responseType, _options, _params, _CONTENT_TYPES$respon2;
    ...
    var responseType = (_options$responseType = (_options = options) === null || _options === void 0 ? void 0 : _options.responseType) !== null && _options$responseType !== void 0 ? _options$responseType : 'json';
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info("".concat(operationName, " succeeded. The result of this operation will be in ").concat(operationName, " state.data or in your ").concat(operationName, " callback."));
...
function getSchema(resourceType, params, options, callback) {
  return function (state) {
    var _options$responseType2, _options2, _params2, _params3, _options$apiVersion, _options3, _CONTENT_TYPES$respon3, _resourceType;
    ...
    var responseType = (_options$responseType2 = (_options2 = options) === null || _options2 === void 0 ? void 0 : _options2.responseType) !== null && _options$responseType2 !== void 0 ? _options$responseType2 : 'json';
    ...
    var apiVersion = (_options$apiVersion = (_options3 = options) === null || _options3 === void 0 ? void 0 : _options3.apiVersion) !== null && _options$apiVersion !== void 0 ? _options$apiVersion : state.configuration.apiVersion;
    var headers = {
...
function getData(resourceType, params, options, callback) {
  return function (state) {
    var _options$operationNam, _options4, _options$responseType3, _options5, _params4, _params5, _params6, _options$apiVersion2, _options6, _CONTENT_TYPES$respon4;

    resourceType = (0, _languageCommon.expandReferences)(resourceType)(state);
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam = (_options4 = options) === null || _options4 === void 0 ? void 0 : _options4.operationName) !== null && _options$operationNam !== void 0 ? _options$operationNam : 'getData';
    ...
    var responseType = (_options$responseType3 = (_options5 = options) === null || _options5 === void 0 ? void 0 : _options5.responseType) !== null && _options$responseType3 !== void 0 ? _options$responseType3 : 'json';
    ...
    var apiVersion = (_options$apiVersion2 = (_options6 = options) === null || _options6 === void 0 ? void 0 : _options6.apiVersion) !== null && _options$apiVersion2 !== void 0 ? _options$apiVersion2 : state.configuration.apiVersion;
    var headers = {
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info("".concat(operationName, " succeeded. The result of this operation will be in ").concat(operationName, " state.data or in your callback."));
...
function getMetadata(resources, params, options, callback) {
  return function (state) {
    var _options$responseType4, _options7, _queryParams, _queryParams2, _options$apiVersion3, _options8, _CONTENT_TYPES$respon5;
    ...
    var responseType = (_options$responseType4 = (_options7 = options) === null || _options7 === void 0 ? void 0 : _options7.responseType) !== null && _options$responseType4 !== void 0 ? _options$responseType4 : 'json';
    ...
    var apiVersion = (_options$apiVersion3 = (_options8 = options) === null || _options8 === void 0 ? void 0 : _options8.apiVersion) !== null && _options$apiVersion3 !== void 0 ? _options$apiVersion3 : state.configuration.apiVersion;
    var headers = {
...
function patch(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam2, _options9, _options$responseType5, _options10, _queryParams3, _queryParams4, _options$apiVersion4, _options11, _CONTENT_TYPES$respon6;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam2 = (_options9 = options) === null || _options9 === void 0 ? void 0 : _options9.operationName) !== null && _options$operationNam2 !== void 0 ? _options$operationNam2 : 'patch';
    ...
    var responseType = (_options$responseType5 = (_options10 = options) === null || _options10 === void 0 ? void 0 : _options10.responseType) !== null && _options$responseType5 !== void 0 ? _options$responseType5 : 'json';
    var queryParams = params;
    ...
    var apiVersion = (_options$apiVersion4 = (_options11 = options) === null || _options11 === void 0 ? void 0 : _options11.apiVersion) !== null && _options$apiVersion4 !== void 0 ? _options$apiVersion4 : state.configuration.apiVersion;
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info("".concat(operationName, " succeeded. Updated ").concat(resourceType, ".\nSummary:\n").concat((0, _Utils.prettyJson)(resultObject)));
...
function del(resourceType, path, data, params, options, callback) {
  return function (state) {
    var _options$operationNam3, _options12, _options$responseType6, _options13, _queryParams5, _queryParams6, _options$apiVersion5, _options14, _CONTENT_TYPES$respon7;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam3 = (_options12 = options) === null || _options12 === void 0 ? void 0 : _options12.operationName) !== null && _options$operationNam3 !== void 0 ? _options$operationNam3 : 'delete';
    ...
    var responseType = (_options$responseType6 = (_options13 = options) === null || _options13 === void 0 ? void 0 : _options13.responseType) !== null && _options$responseType6 !== void 0 ? _options$responseType6 : 'json';
    var queryParams = params;
    ...
    var apiVersion = (_options$apiVersion5 = (_options14 = options) === null || _options14 === void 0 ? void 0 : _options14.apiVersion) !== null && _options$apiVersion5 !== void 0 ? _options$apiVersion5 : state.configuration.apiVersion;
    var headers = {
    ...
    return _axios["default"].request({
      ...
      _Utils.Log.info("".concat(operationName, " succeeded. DELETED ").concat(resourceType, ".\nSummary:\n").concat((0, _Utils.prettyJson)(result.data)));
...
function upsert(resourceType, uniqueAttribute, data, params, options, callback) {
  return function (state) {
    var _options$operationNam4, _options15, _options$replace, _options16, _options$responseType7, _options17, _params7, _options$apiVersion6, _options18, _CONTENT_TYPES$respon8;
    ...
    params = (0, _languageCommon.expandReferences)(params)(state);
    options = (0, _languageCommon.expandReferences)(options)(state);
    var operationName = (_options$operationNam4 = (_options15 = options) === null || _options15 === void 0 ? void 0 : _options15.operationName) !== null && _options$operationNam4 !== void 0 ? _options$operationNam4 : 'upsert';
    ...
    var replace = (_options$replace = (_options16 = options) === null || _options16 === void 0 ? void 0 : _options16.replace) !== null && _options$replace !== void 0 ? _options$replace : false;
    var responseType = (_options$responseType7 = (_options17 = options) === null || _options17 === void 0 ? void 0 : _options17.responseType) !== null && _options$responseType7 !== void 0 ? _options$responseType7 : 'json';
    ...
    _Utils.Log.info("Checking if a record exists that matches this filter: attribute{ id: ".concat(attributeId, ", value: ").concat(attributeValue, " } ..."));

    return Promise.all([getResouceName(), findRecordsWithValueOnAttribute()]).then(function (_ref4) {
      var _ref5 = _slicedToArray(_ref4, 2),
          resourceName = _ref5[0],
          recordsWithValue = _ref5[1];
      ...
      if (recordsWithValueCount > 1) {
        ...
        //   );
        // }
        _Utils.Log.info("Attribute has unique values. Proceeding to ".concat(replace ? 'replace' : 'merge', " ..."));
        ...
        return _axios["default"].request({
          ...
          _Utils.Log.info("".concat(operationName, " succeeded. Updated ").concat(resourceName, ": ").concat(updateUrl, ".\nSummary:\n").concat((0, _Utils.prettyJson)(result.data)));
        ...
        return _axios["default"].request({
          ...
          _Utils.Log.info("".concat(operationName, " succeeded. Created ").concat(resourceName, ": ").concat(result.data.response.importSummaries ? result.data.response.importSummaries[0].href : (_result$data$response3 = result.data.response) === null || _result$data$response3 === void 0 ? void 0 : _result$data$response3.reference, ".\nSummary:\n").concat((0, _Utils.prettyJson)(result.data)));
