...
function getTEIs(params, responseType, options, callback) {
...
function upsertTEI(uniqueAttributeId, data, options, updateCondition, params, callback) {
  return function (state) {
    var _options$apiVersion, _options$supportApiVe, _options$requireUniqu, _params, _params$find, _params2, _params3, _state$data$attribute, _state$data$attribute2;
    ...
    var ou = (_params$find = (_params2 = params) === null || _params2 === void 0 ? void 0 : _params2.find(function (obj) {
      return obj.hasOwnProperty('ou');
    })) !== null && _params$find !== void 0 ? _params$find : {
      ou: state.data.orgUnit
    };
    console.log('ou is', ou);
    (_params3 = params) === null || _params3 === void 0 ? void 0 : _params3.push(ou);
    ...
    return Promise.all([findTrackedEntityType(), requireUniqueAttributeConfig === true ? isAttributeUnique() : Promise.resolve({
      ...
      }, updateCondition, body, params, options, callback)(state);
    });
  };
}
/**
...
function create(resourceType, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion5, _options$supportApiVe5, _CONTENT_TYPES$respon5;
...
function update(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion6, _options$supportApiVe6, _CONTENT_TYPES$respon6;
...
function patch(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion7, _options$supportApiVe7, _CONTENT_TYPES$respon7;
...
function del(resourceType, path, data, params, options, responseType, callback) {
  return function (state) {
    var _options$apiVersion8, _CONTENT_TYPES$respon8, _options$supportApiVe8;
...
function upsert(resourceType, uniqueAttribute, updateCondition, data, params, options, responseType, callback) {
  return function (state) {
    var _options$replace, _options$apiVersion9, _options$supportApiVe9, _CONTENT_TYPES$respon9;
