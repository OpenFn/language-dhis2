...
exports.FIELD_TRANSFORMERS = exports.FIELD_FILTERS_PRESETS = exports.FIELD_FILTERS_SYNTAX = exports.OBJECT_FILTER_OPERATORS = exports.QUERY_PARAMETERS = exports.PUNCTUATIONS = exports.CONTENT_TYPES = exports.MEDIA_TYPES = exports.HTTP_HEADERS = exports.dhis2OperatorMap = exports.HTTP_METHODS = exports.Log = void 0;
...
var QUERY_PARAMETERS = [{
  ...
  description: 'Indicates whether to get all resources or no resources by default.'
}, {
  param: 'viewClass',
  type: 'enum',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Alternative views of the metadata. Please note that only metadata exported with viewClass=export or detailed can be used for import.'
}, {
  param: 'dryRun',
  type: 'boolean',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'If you set this to true, the actual import will not happen. Instead the system will generate a summary of what would have been done.'
}, {
  param: '{resources}',
  type: 'boolean',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Default depends on assumeTrue. Run getResources() to see available resources. Indicates which resources to include in the response.'
}, {
  param: 'lastUpdated',
  type: 'date',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Import strategy to use. CREATE_AND_UPDATE=Allows creation and updating of objects. CREATE=Allows creation of objects only. UPDATE=Allows update of objects only. DELETE=Allows deletes of objects only.'
}, {
  param: 'sharing',
  type: 'boolean',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Should sharing be supported or not. The default is false, which is the old behavior. You can set this to true to allow updating user, publicAccess and userGroupAccesses fields (if not they are cleared out on create, and not touched on update).'
}, {
  param: 'mergeMode',
  type: 'enum',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Default field filter to apply for all types, default is :owner.'
}, {
  param: 'filter',
  type: 'string',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Default object filter to apply for all types, default is none.'
}, {
  param: 'order',
  type: 'string',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Default order to apply to all types, default is name if available, or created if not.'
}, {
  param: 'translate',
  type: 'boolean',
  required: false,
  ...
  isMetadataExportParam: true,
  isMetadataImportParam: false,
  description: 'Enable translations. Be aware that this is turned off by default (in other endpoints this is on by default).'
}, {
  param: 'locale',
  type: 'string',
  required: false,
  ...
  description: 'Sets overall import mode, decides whether or not to only VALIDATE or also COMMIT the metadata, this have similar functionality as our old dryRun flag.'
}, {
  param: 'identifier',
  type: 'enum',
  required: false,
  ...
  isMetadataExportParam: false,
  isMetadataImportParam: true,
  description: 'Sets the identifier scheme to use for reference matching. AUTO means try UID first, then CODE.'
}];
/**
