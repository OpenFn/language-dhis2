...
exports.HTTP_METHODS = exports.Log = void 0;
...
function warnExpectLargeResult(resourceType, endpointUrl) {
  if ((0, _lodash.isEmpty)(resourceType)) Log.warn("This may take a while. This endpoint(".concat(endpointUrl, ") may return a large collection of records, since 'resourceType' is not specified. We recommend you specify 'resourceType' or use 'filter' parameter to limit the content of the result."));
}
/**
