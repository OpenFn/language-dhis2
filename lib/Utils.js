...
function logWaitingForServer(url, params) {
  ...
  console.info("params ".concat(COLORS.FgGreen).concat(params, "\x1B[0m"));
...
function attribute(attributeId, attributeValue) {
  return {
    attribute: (0, _languageCommon.expandReferences)(attributeId),
    value: (0, _languageCommon.expandReferences)(attributeValue)
  };
}
/**
...
function getIndicesOf(string, regex) {
  ...
  while (match = regex.exec(string)) {
    ...
    console.log('SchemaRef: ', schemaRef); // let item = {};
