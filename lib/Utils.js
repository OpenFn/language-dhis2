...
function logApiVersion(apiVersion) {
  ...
  if (apiVersion) Log.warn(message);else Log.warn("Using \x1B[33m latest \x1B[0m version of DHIS2 api.");
}
...
function buildUrl(path, hostUrl, apiVersion) {
  var useApiVersion = apiVersion !== null && apiVersion !== void 0 ? apiVersion : false;
